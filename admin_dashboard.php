...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg card-hover" style="height:450px;">
        <h3 class="text-lg font-bold text-gray-800 mb-4">Career Distribution</h3>
        <canvas id="adminChart" width="600" height="320" class="w-full h-80"></canvas>
    </div>
</div>
